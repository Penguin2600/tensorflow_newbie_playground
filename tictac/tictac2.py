...
class Board(object):
	...
	def check_vector(self, iterator):
		...
		if bool(bool(len(set(iterator)) == 1) and iterator[0]!=0.5):
			return True

	def itemgetter(self, indicies, iterator):
		return [iterator[i] for i in indicies]
...
if __name__ == "__main__":
	...
	p2=Player('p2', 'human', 0)
	board=Board()
	localgame=TicTacGame(board, p1, p2)
	localgame.start_game()
