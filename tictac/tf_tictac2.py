...
do_training = 0 # 1 = do the training, 0 = load from file and just run it
    ...
    with tf.name_scope('play_game'):
        for _ in range(ITTERCOUNT):
            ...
            while localgame.winner==None:
                ...
                inputs = localgame.board.board
                #print(localgame.board.board)
                ...
                if localgame.current_player.name=='ai_player':
                  history.append((inputs, localgame.current_player.move))
